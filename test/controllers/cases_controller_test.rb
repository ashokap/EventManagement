...
class CasesControllerTest < ActionController::TestCase
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post :create, case: { ending_date: @case.ending_date, name: @case.name, next_hearing: @case.next_hearing, stage: @case.stage, starting_date: @case.starting_date }
    end
  ...
  test "should update case" do
    patch :update, id: @case, case: { ending_date: @case.ending_date, name: @case.name, next_hearing: @case.next_hearing, stage: @case.stage, starting_date: @case.starting_date }
    assert_redirected_to case_path(assigns(:case))
  end
